...
```{r}
library(readr)
dat <- read_csv("C:/Users/K0012/Downloads/pizzadelivery (1).csv")
...
En este caso se puede observar que la operadora Laura recibe mayor número de llamadas, aunque es mínima la diferencia entre operadoras.
...
Esta gráfica representa el porcentaje de vinos gratis que prometían ser entregados por los repartidores a los clientes, 1 haciendo referencia a vinos que se tenían que entregar gratis.
...
La gráfica muestra el porcentaje de botellas de vino gratis que si fueron entregadas a los clientes por los repartidores, siendo 1 el porcentaje de vinos entregados.
...
La gráfica muestra el porcentaje de veces que se hicieron o no descuentos a los clientes, siendo 1 el porcentaje de descuentos asignado.
...
Teniendo en cuenta el tiempo de entrega de cada repatidor durante el mes de mayo, se puede deducir que el que tuvo mejor rendimiento fue Domenico ubicándose en el cuartil inferior; es decir, Domenico es el que se más cerca al mínimo de datos del tiempo, por lo tanto, se entiende que fue el que tuvo mejor rendimiento respecto a esta variable.
