...
```{r}
    ...
    barplot(table, beside = T, col = rainbow(5), legend.text = TRUE,
...
weekend_pizzas = sum(dat[dat$day == 'Friday' | dat$day == 'Saturday' | dat$day == 'Sunday', 10])
weekday_pizzas = sum(dat[dat$day != 'Friday' | dat$day != 'Saturday' | dat$day != 'Sunday', 10])
barplot(c(weekday_pizzas, weekend_pizzas), main = "# pizzas", legend = c("Weekday", "Weekend"), col = c(1, 2))

weekend_bill = sum(dat[dat$day == 'Friday' | dat$day == 'Saturday' | dat$day == 'Sunday', 9])
weekday_bill = sum(dat[dat$day != 'Friday' | dat$day != 'Saturday' | dat$day != 'Sunday', 9])
barplot(c(weekday_bill, weekend_bill), main = "Earnings", legend = c("Weekday", "Weekend"), col = c(1, 2))
```
