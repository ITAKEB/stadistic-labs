...
#Probabilidad de que una persona seleccionada al azar:
  ...
  - Probabilidad de que juegue beisbol y sea adulta
    R/ 0

  - Probabilidad de que sea joven.
    R/ 202/300= 0.67333333

  - Probabilidad de que juegue futbol dado que es una persona adulta.
    R/ 0.44897959

  - Probabilidad de que sea joven si le gusta jugar baloncesto.
    R/ 0.6304348

  - Probabilidad de que juegue baloncesto o b́eisbol dado que es una persona joven
    R/ total de jovenes que juegan baloncesto y beisbol 58+68 = 126
       126/202 = 0.6237623

  - Probabilidad dado que es una persona adulta, no juegue tenis.
    R/ total de adulto que no juegan tenis -> 34+0+44 = 78
       78/98 = 0.7959183
...
#-En el experimento encontramos un caso de exito, que en este caso es ser hembra y de fracaso que es ser macho
...
# R/ Esta aproximación nos indica que la propablidad de que sean hasta 60 es 0.02994174 y con estos resultados calculamos el porcentaje de error.
...
# R/ Esta aproximación nos indica que la propabilidad de que al menos se produzcan 20 terremotos en el año es de 0.2721448 y con estos resultados calculamos el porcentaje de error.
...
Para encontrar el tiempo medio entre dos llamadas sucesivas, se puede utilizar el hecho de que la distribución exponencial tiene una media igual a 1/λ, donde λ es la tasa media de llegada de los eventos. En este caso, λ = 4 llamadas por minuto, por lo que el tiempo medio entre dos llamadas sucesivas es de 1/4 = 0.25 minutos o 15 segundos.
