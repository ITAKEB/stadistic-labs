...
//Este punto se podia hacer despejando
#### 1)
...
curve(dunif(x, xbar, xbar+1), add = TRUE, col = "red", lwd = 5)
```
...
H0 -> p = 0.5 hipotesis nula
H1 -> p > 0.5 hipotesis alternativa

```{r}
p_value <- 1 - pbinom(20, 50, 0.5)
alpha <- 0.05
```
